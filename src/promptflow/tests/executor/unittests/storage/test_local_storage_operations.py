...
def node_run_info():
    return RunInfo(
        ...
        inputs={"image1": BaseMultimediaProcessor().create_image({"data:image/png;base64": "R0lGODlhAQABAAAAACw="})},
        output={"output1": BaseMultimediaProcessor().create_image({"data:image/png;base64": "R0lGODlhAQABAAAAACw="})},
        metrics={},
        error={},
